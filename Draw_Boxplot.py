...
# rewardLen_2 = [random.randint(1980, 2250) for _ in range(200)]
# Heterogeneous = [random.randint(2200, 2500) for _ in range(200)]
# rewardLen_8 = [random.randint(1380, 1600) for _ in range(200)]
# rewardLen_11 = [random.randint(980, 1250) for _ in range(200)]


compareList = [rewardLen_2, Heterogeneous, rewardLen_8, rewardLen_11]
labels = [r'$\tau $' + '=2', r'$\tau $' + '=5', r'$\tau $' + '=8', r'$\tau $' + '=11']
figPath = 'RewardBoxplot.png'  # 存储图像的地址
